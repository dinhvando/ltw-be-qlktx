...
//    @Query(value = "select new dodv.dormitorymanagement.demo.dto.response.Test(" +
//            "room2.id,room2.name,room2.priceRoom,room2.type,room2.maxPeople" +
//            ") " +
//            " from " +
